{{--
    ...
    Props:
    - type: 'view' | 'edit' | 'delete' | 'activate' | 'custom' (default: 'custom')
...
<button
    {{ $attributes->merge([
        'class' => "w-8 h-8 flex items-center justify-center rounded-md {$currentConfig['bg']} transition-colors duration-150",
        'title' => $title
    ]) }}
>
