{{--
    ...
    Descripción: Listado simple de usuarios del sistema con su información básica
--}}
<div>
    {{-- Breadcrumbs --}}
    <x-breadcrumbs :items="[
    ...
    {{-- Encabezado con título y botón para agregar usuario --}}
                ...
                <tbody class="text-gray-600 text-sm font-light">
                    @foreach ($usuarios as $usuario)
                        <tr class="border-b border-gray-200 hover:bg-gray-100">
                            ...
                            <td class="py-3 px-6 text-left">
                                <span class="bg-purple-200 text-purple-800 py-1 px-3 rounded-full text-xs">{{ $usuario['rol'] }}</span>
                            </td>
